...
const ccy = process.env.CURRENCY;
const mcc = process.env.MCC;
...
exports.payCode = (params) => {
  let $field33 = [
    ["00", "BCEL"],
    ["01", "ONEPAY"],
    ["02", mcid],
  ];
  if (params.expirytime) $field33.push(["03", this.getExpiredTime(params.expirytime)]); // expired time
  ...
  return rawqr + this.buildqr([["63", this.crc16(rawqr + "6304")]]); // Adding itself into checksum
};

exports.getExpiredTime = (expirytime) => {
  let dateTime = new Date();
  dateTime.setMinutes(dateTime.getMinutes() + expirytime);
