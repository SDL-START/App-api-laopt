...
router.get("/getmenus", async (req, res) => {
  try {
    ...
    let items = [
      ...
      {
        title: "ໂປຣໂມຊັນ",
        url: `${appurl}/promotions?app=sinxai`,
    ...
    if (username != "2022224071x") {
      items = [
        {
          title: "ຊື້ເລກ",
          url: `${appurl}/buy?app=sinxai`,
          // icon: "https://cdn-icons-png.flaticon.com/512/536/536095.png",
          icon: "https://ecard-loto.web.app/lottery-logo.png",
          iswebview: true,
          isneedlogin: true,
        },
        {
          title: "ເລກອອກຜ່ານມາ",
          url: `${appurl}/resulthistory?app=sinxai`,
        ...
        },
        {
          ...
          url: `${appurl}/buyhistory?app=sinxai`,
        ...
        {
          title: "ເລກເດັດ",
          url: `${appurl}/goodnumber?app=sinxai`,
